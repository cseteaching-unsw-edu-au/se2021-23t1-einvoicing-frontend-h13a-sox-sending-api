      ...
      <div className="navigation-c">
        <div style={{ display: 'flex' }}>
          ...
          <NavLink to="/SendInvoice">
            { location.pathname === "/SendInvoice" ? <img src={blue_send} alt="Send Invoice" /> : <img src={white_send} alt="Send Invoice" /> }
          </NavLink>
          <NavLink to="/StoreInvoice">
            { location.pathname === "/StoreInvoice" ? <img src={blue_store} alt="Store Invoice" /> : <img src={white_store} alt="Store Invoice" /> }
          </NavLink>
          <NavLink to="/Inbox">
